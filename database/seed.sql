...
INSERT INTO branches (id, organization_id, branch_code, name, address, phone, email, timezone, is_active, is_default)
VALUES (
...
VALUES
  ('55555555-5555-5555-5555-555555555551', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', 'Sarah Johnson', '33333333-3333-3333-3333-333333333331', 'Sarah Johnson', 'PAT-0001', '(555) 123-4567', 'sarah.j@email.com', '44444444-4444-4444-4444-444444444441', 'consultation', CURRENT_DATE, '09:00', 15, 'Blood pressure review', 'Check follow-up medication response'),
  ('55555555-5555-5555-5555-555555555552', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', 'Mike Chen', '33333333-3333-3333-3333-333333333332', 'Mike Chen', 'PAT-0002', '(555) 234-5678', 'mike.c@email.com', '44444444-4444-4444-4444-444444444442', 'follow-up', CURRENT_DATE + INTERVAL '2 day', '11:30', 30, 'Routine child wellness visit', 'General follow-up discussion'),
  ('55555555-5555-5555-5555-555555555553', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', 'Emma Davis', '33333333-3333-3333-3333-333333333333', 'Emma Davis', 'PAT-0003', '(555) 345-6789', 'emma.d@email.com', '44444444-4444-4444-4444-444444444443', 'procedure', DATE_TRUNC('month', CURRENT_DATE) + INTERVAL '10 day', '15:00', 45, 'Minor orthopedic procedure', 'Operations planning meeting')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('66666666-6666-6666-6666-666666666661', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', '33333333-3333-3333-3333-333333333331', '44444444-4444-4444-4444-444444444441', 'Lab Results', 'completed', CURRENT_DATE - INTERVAL '1 day', 'Lipid profile normal'),
  ('66666666-6666-6666-6666-666666666662', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', '33333333-3333-3333-3333-333333333332', '44444444-4444-4444-4444-444444444442', 'X-Ray', 'pending review', CURRENT_DATE - INTERVAL '2 day', 'Requires specialist review')
ON CONFLICT (id) DO NOTHING;

INSERT INTO activity_logs (id, organization_id, branch_id, event_type, title, entity_name, event_time)
VALUES
  ('77777777-7777-7777-7777-777777777771', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', 'registration', 'New patient registered', 'Sarah Johnson', NOW() - INTERVAL '10 minute'),
  ('77777777-7777-7777-7777-777777777772', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', 'record', 'Medical record updated', 'Mike Chen', NOW() - INTERVAL '25 minute'),
  ('77777777-7777-7777-7777-777777777773', '11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888881', 'record', 'Lab review completed', 'Emma Davis', NOW() - INTERVAL '1 hour')
ON CONFLICT (id) DO NOTHING;
